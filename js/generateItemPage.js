...
const generateItemPage = () => {
    ...
    const renderCard = ({ category, count, description, id, name: itemName, img, price, subcategory }) => {
        //console.log(data)
        ...
        breadcrumbLink.forEach(item => {
            item.textContent = arr.forEach(el => el.textContent);
        });*/
